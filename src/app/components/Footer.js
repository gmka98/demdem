...
<footer className="bg-black text-white dark:bg-gray-900">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-white sm:text-center">© 2023 <a href="/" className="hover:underline">DemezVous™</a>. All Rights Reserved.
          </span>
          <span className="text-white">Build by Gmk</span>
          <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
              <a href="#" className="text-white hover:text-red-500 dark:hover:text-white">
